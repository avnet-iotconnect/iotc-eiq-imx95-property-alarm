...
prefill cost does not get averaged into the decode rate. README.md beside this
file has the numbers to compare against.

Run it from the host, with the connector serving on the board:

    python3 benchmarks/ara/bench-ara.py
