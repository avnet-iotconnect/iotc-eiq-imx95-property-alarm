...
NXP's eIQ wake word, recogniser and TTS, turned into something that runs forever on its own thread,
next to a 30 fps video loop it must never disturb. What it does, once per utterance:
...
Traps in NXP's API, all learned on the board:
