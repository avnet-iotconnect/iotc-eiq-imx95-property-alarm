...
#
#   scp -r koala root@<board>:                        # this directory rides along
#   ssh root@<board> 'cd koala/connector && ./install.sh'
#
# Kept out of koala's own install.sh on purpose: this is gigabytes and minutes for
