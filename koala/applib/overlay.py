...
def annotate_frame(frame_rgb, tracks: list[Track], hud_lines=()):
    ...
    This re-renders in OpenCV what Cairo already drew on the preview, and iguana needs it less than
    hyena did. Tapping the pipeline *after* `cairooverlay` (see camera.py) means the composed
