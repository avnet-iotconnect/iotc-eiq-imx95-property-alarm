...
class IotcClient:
    ...
    def _connect(self) -> None:
        ...
        self._client = Client(
            config=config,
            # No vs_cb: iguana does not take streaming start/stop instructions from the back end.
...
def resolve_credentials(config_path: Path, cert_path: Path | None,
    ...
    configured, costs nothing and makes `deploy.sh` and this function independent of which device
    they are looking at.
    """
